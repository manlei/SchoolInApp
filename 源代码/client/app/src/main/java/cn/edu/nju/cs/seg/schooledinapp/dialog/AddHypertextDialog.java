...
public class AddHypertextDialog extends CustomBaseDialog {

	// Update flag
	public static final int ADDHYPERLINK_SUCCEEDED = -1;

	private static final String TAG = "AddHypertextDialog";
	...
	protected int getResourseLayoutId() {
		return R.layout.dialog_add_hyperlink;
	}
	...
	protected void onClickPositiveButton(View dialogView) {
		...
		hyperText = ((TextView) findViewById(R.id.et_hyperlink_text)).getText().toString();
		hyperLink = ((TextView) findViewById(R.id.et_hyperlink_link)).getText().toString();
	...
	public AddHypertextDialog(BaseActivity activity, DialogResultWithRequestCodeListener listener) {
		super(activity);
	...
	private void onHyperTextInputError() {
		...
		final TextView tvHyperTextError =
				(TextView) findViewById(R.id.et_hyperlink_text_error);
	...
	private void onHyperLinkInputError() {
		...
		final TextView tvHyperLinkError =
				(TextView) findViewById(R.id.et_hyperlink_link_error);
