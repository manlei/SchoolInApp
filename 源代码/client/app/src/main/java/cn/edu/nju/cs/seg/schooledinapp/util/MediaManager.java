...
public class MediaManager {
    ...
    public static void playLoacalAudio(String filePathString,
    ...
    public static void playRemoteAudio(@Url String fileUrlString,
                                       Context context,
                                       OnCompletionListener onCompletionListener) {
        if (mPlayer == null) {
            mPlayer = new MediaPlayer();
        ...
        try {
            mPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
            mPlayer.setOnCompletionListener(onCompletionListener);
            mPlayer.setDataSource(context, Uri.parse(fileUrlString));
            mPlayer.prepare();
