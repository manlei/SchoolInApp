...
public class UserQuestionItemAdapter
        extends BaseItemAdapter<UserQuestionItem, UserQuestionItemAdapter.ViewHolder> {

    public static final String TAG = "UserQuestionItemAdapter";
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            llItem = (LinearLayout) v.findViewById(R.id.ll_user_questions_item);
            vVerticalSeparator = (View) v.findViewById(R.id.v_user_questions_vertical_line);
            tvDirectedTo = (TextView) v.findViewById(R.id.tv_user_questions_directed_to);
            tvTitle = (TextView) v.findViewById(R.id.tv_user_questions_title);
            tvHeat = (TextView) v.findViewById(R.id.tv_user_questions_heat);
            tvSupports = (TextView) v.findViewById(R.id.tv_user_questions_supports);
            tvCreatedAt = (TextView) v.findViewById(R.id.tv_user_questions_created_at);
        }

    }

    public UserQuestionItemAdapter(List<UserQuestionItem> userQuestionItemList) {
        super(userQuestionItemList);
    }

    @Override
    protected View doInflateItemView(LayoutInflater inflater, ViewGroup parent) {
        return inflater.inflate(R.layout.user_questions_item_question, parent, false);
    }
    ...
    protected void doBindItemEvents(View itemView, final ViewHolder holder) {
        ...
        holder.llItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final UserQuestionItem item = getItemList().get(holder.getAdapterPosition());
                                    ...
                                    public void onResponse(Call<Void> call, Response<Void> response) {
                                        switch(response.code()){
                                            case 204:{
                                                //删除
                                                popupWindow.dismiss();
                                                UserQuestionItemAdapter.this.getItemList().remove(holder.getAdapterPosition());
                                                UserQuestionItemAdapter.this.notifyDataSetChanged();
    ...
    @Override
    protected void doBindViewHolder(ViewHolder holder, UserQuestionItem item) {
