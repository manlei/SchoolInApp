...
import cn.edu.nju.cs.seg.schooledinapp.dialog.AudioRecordingDialog;
import cn.edu.nju.cs.seg.schooledinapp.util.AudioManager;
 ...
 *
 */
public class AudioRecordingButton
        extends Button
    ...
    // 录音对话框
    private AudioRecordingDialog mDialogManager;
    // 核心录音类
    ...
    public AudioRecordingButton(Context context, AttributeSet attrs) {
        ...
        // 初始化语音对话框
        mDialogManager = new AudioRecordingDialog(getContext());
        ...
        if (mCurrentState != state) {
            ...
            switch (mCurrentState) {
                case STATE_NORMAL:
                    ...
                    setText(mContext.getString(R.string.btn_audio_recording_long_click_record));// 长按录音
                    break;

                case STATE_RECORDING:
                    setBackgroundResource(R.color.fentchGrey);
                    setText(R.string.tv_audio_recording_hang_up_finsh);// 松开结束
                ...
                case STATE_WANT_TO_CANCEL:
                    setText(R.string.tv_audio_recording_release_cancel);// 松开取消
