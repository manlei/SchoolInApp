...
public class EssayCommentItemAdapter
        extends BaseItemAdapter<EssayCommentItem, EssayCommentItemAdapter.ViewHolder> {
    ...
    public EssayCommentItemAdapter(List<EssayCommentItem> commentItemList) {
    ...
    @Override
    protected void doBindViewHolder(ViewHolder holder, EssayCommentItem item) {
